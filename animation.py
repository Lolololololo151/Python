...
class BodyBall:
    ...
    def draw(self, surface):
        pygame.draw.circle(surface, (100, 100, 100), (self.pos[0], self.pos[1]), self.radius, 5)
        pygame.draw.circle(surface, (0, 100, 0), self.left_point_pos, 5)
        pygame.draw.circle(surface, (100, 0, 0), self.right_point_pos, 5)
        if self.forward_point_pos:
            pygame.draw.circle(surface, (0, 0, 100), self.forward_point_pos, 5)
            pygame.draw.circle(surface, (100, 0, 100), self.left_forward_point_pos, 5)
            pygame.draw.circle(surface, (0, 100, 100), self.right_forward_point_pos, 5)
        if self.backward_point_pos:
            pygame.draw.circle(surface, (0, 0, 100), self.backward_point_pos, 5)
            pygame.draw.circle(surface, (100, 0, 100), self.left_backward_point_pos, 5)
            pygame.draw.circle(surface, (0, 100, 100), self.right_backward_point_pos, 5)



class Animal:
    def __init__(self, animal_name: str="slug", size_factor: float=1.0, color: tuple=(79, 227, 134), debug: bool=False):
    ...
    def draw_animal(self, surface: pygame.Surface):
        ...
        if self.animal_name == "robocode":
            ...
            for index, ball in enumerate(self.body[1:-1]):
                ...
                surface.blit(rotated_word, rotated_rect)



        # size rect
        if self.debug:
            pygame.draw.circle(surface, (255, 0, 0), animal_rect.center, 5)
            pygame.draw.circle(surface, (255, 0, 0), animal_rect.bottomleft, 5)
            pygame.draw.circle(surface, (255, 0, 0), animal_rect.bottomright, 5)
            pygame.draw.circle(surface, (255, 0, 0), animal_rect.topleft, 5)
            pygame.draw.circle(surface, (255, 0, 0), animal_rect.topright, 5)
            pygame.draw.circle(surface, (255, 0, 0), animal_rect.midbottom, 5)
            pygame.draw.circle(surface, (255, 0, 0), animal_rect.midleft, 5)
            pygame.draw.circle(surface, (255, 0, 0), animal_rect.midright, 5)
            pygame.draw.circle(surface, (255, 0, 0), animal_rect.midtop, 5)

            pygame.draw.rect(surface, (100, 0, 100), self.rect())
            for ball in self.body:
                ball.draw(surface)
